...
M118 min0: {first_layer_print_min[0]}
M118 min1: {first_layer_print_min[1]}
M118 max0: {first_layer_print_max[0]}
M118 max1: {first_layer_print_max[1]}
...
{if first_layer_print_min[1] < 110 or first_layer_print_max[1]>310 or first_layer_print_min[0]<110 or first_layer_print_max[0]x>310}
  ; --- First Layer Minimum is outside the specified range ---
...
{else}
  ; --- First Layer Minimum is within the specified range ---
